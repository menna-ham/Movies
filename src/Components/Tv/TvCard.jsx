...
export default function TvCard(props) {
  ...
  return (
    ...
    <Link className='nav-link h-100' to={`/details/tv/${id}`}>
          ...
          <div className='p-3 btn rounded-3 my-3 bg-danger favBtn text-white ' onClick={(e)=>addFavorite(e,obj,'tv')} >
